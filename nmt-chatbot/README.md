### NMT-Chatbot Mirrored from [daniem-kukiela](https://github.com/daniel-kukiela/nmt-chatbot).
#### Modified [Tensorflow NMT Model](https://github.com/tensorflow/nmt) to complete English to English Translation.
#### I have pasted the original README below.
===================
